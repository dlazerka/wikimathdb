...
терминологий. Итак, идея родилась.
\\
...
Почему "следовательно"? Может быть в некоторых теориях это не верно?
Здесь вы можете указать системе WikiMathDB объяснить, почему это
верно (например, контрол-кликнув на слово "следовательно"). И
...
writing a definition like for "basis", author should consider these
details while adding anything to the WikiMathDB.
\\
\newpage
